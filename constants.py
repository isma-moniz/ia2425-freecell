...
WEIGHT_PROFILES = {
    ...
    "mid": {
        # Original weights
        "FOUNDATION_MULTIPLIER": 300,
        "FREECELL_MULTIPLIER": 1,
        "ORDER_MULTIPLIER": 2,
        "TABLEAU_EMPTY_SCORE": 2,
        "CARD_EXCAVATION_MULTIPLIER": 20,
        "MOVE_COUNT_SCORE": 0.2,

        "CHAIN_MULTIPLIER": 1,
        "BLOCKED_CARD_PENALTY": 2,
    ...
    "late": {
        ...
        "CARD_EXCAVATION_MULTIPLIER": 80,
        "MOVE_COUNT_SCORE": 0.2,

        "CHAIN_MULTIPLIER": 0,
        "BLOCKED_CARD_PENALTY": 0,
...
STAGNATION_THRESHOLD_MID = 200
STAGNATION_THRESHOLD_LATE = 300